static char rtape_lib_id_string[] = "rtape_lib version of 930224 16:55 drs";
...
#ifndef lint
static char *RCSid = "$Header: rmtlib.c,v 1.6 88/10/25 17:04:29 root Locked $";
#endif
