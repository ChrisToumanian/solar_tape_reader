...
C
      parameter (ix=512, jx=512, kx=ix*jx, npasx=5)
      parameter (nlmbx=3)
...
C
      data idbg,ludbg     /0,6/
      data xc0, yc0, rad0 /256., 256., 225./
      data aex, aey, aer  /3*.1/
...
C---- data imskn, imskx, jmskn, jmskx /40,994,30,994/ --18Nov93--
      data imskn, imskx, jmskn, jmskx /55,470,60,480/
      data xcd, ycd,fdop  /256., 256., 30000.0/
C
      read (lui,*) idbg, ludbg
C
