...
C---- data imskn, imskx, jmskn, jmskx /40,994,30,994/ --18Nov93--
      ...
      data xcd, ycd,fsum  /512., 512., 30000.0/
C
      read (lui,*) idbg, ludbg
C
...
C
   ...
   15 continue
      ...
      write(luo,*) 'Doppler scaling factor :',fsum
      if (lmbdir.ne.'-')
...
C
      call cmpsum(imgred, imgblu, imgdop, ix, jx
     &,           redellips, bluellips, xcd, ycd, fsum)
C
